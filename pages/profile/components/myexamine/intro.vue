  ...
  <div class="examine-intro">
    ...
    <div class="examine-bottom">
      ...
      <div class="ask">
        ...
        <p>参与【认证考试】前，学员在对应学院的在线学习时间需累计满30学时。其中，只有学员在观看完所选课程的全部视频后，学时才会累加。</p>
      </div>
      <div class="ask">
        <p class="tit">2. 认证考试</p>
        <p>学员需在2小时内作答30道题，所有试题均为客观题（即单选题、多选题）。题目将从学员已完成课程的题库中随机抽取。</p>
      </div>
      <div class="ask">
      ...
      <div class="ask">
        ...
        <p>学员在正式考试前，可享有2次模拟考试机会，了解试题形式及内容重点。模拟考试试题由学院题库中随机抽取的30道题组成，两次模拟考试试题不一样。</p>
      </div>
      <div class="ask">
        <p class="tit">5. 颁发证书</p>
        <p>学院将根据学员考试成绩颁发相应证书，分数大于18分，即可获得1911学堂结业证书。</p>
      </div>
      <div class="ask">
