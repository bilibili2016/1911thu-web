  ...
  <div>
    <div>
      ...
      >
        ...
        >
          <el-input
            v-model="psnForm.student_number"
            readonly
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            class="telephone"
            v-model="psnForm.user_name"
            disabled
          ></el-input>
          <span
            v-if="psnForm.user_name==''"
            @click="handleBindPhone"
            class="teledit"
          >
            <img
              src="~assets/images/binding.png"
              alt
            >绑定
          </span>
          <span
        ...
        <el-form-item
          label="单位名称"
          v-if="hasCompany"
          key="psnForm.company_name"
        >
          <el-input
            v-model="psnForm.company_name"
            maxlength="30"
