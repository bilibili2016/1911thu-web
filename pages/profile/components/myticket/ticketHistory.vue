  ...
  <div class="tickeHietory">
    ...
    <div
      class="orderList"
      v-for="(ticket, index ) in orderData"
      :key="index"
    >
      ...
      <div class="list">
        <div class="content">
          ...
          <div
            class="number height"
            @click="handleTicketPopup(ticket.id)"
          >
            <div>
              <p>1张发票</p>
          ...
          <div class="status height">
            <div
              v-if="ticket.send_status == '0'"
              @click="handleStatusPopup(ticket.id)"
            >未发出
              <i class="el-icon-arrow-right"></i>
            </div>
            <div
    ...
    <!-- 发票弹框 -->
    <v-detailpop
      v-show="isTicketPopup"
      :data="TicketPopupData"
      @closeTicketPopup="closeTicketPopup"
    ></v-detailpop>

    <!-- 状态弹框 -->
    <v-statuspop
      v-show="isStatusPopup"
