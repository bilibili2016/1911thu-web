  ...
  <div class="goodLesson new-lesson">
    ...
    <div class="breadCrumb">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="main-crumbs">
        ...
        <el-breadcrumb-item>免费专区</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    // 获取精品好课列表
    getNewCourseList() {
      home.getFreeCourseList(this.freeCurriculumForm).then(response => {
    ...
    selectPages(val) {
      this.freeCurriculumForm.pages = val
      this.pagemsg.page = val
      this.freeCurriculumForm.limits = this.pagemsg.pagesize
    ...
    getMoreData() {
      if (this.pageCount === this.courseList.length) {
        ...
        this.freeCurriculumForm.pages = this.freeCurriculumForm.pages + 1
        this.getNewCourseList()
      }
    },
    // 监听下拉刷新方法
