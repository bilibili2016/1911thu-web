    ...
    <div class="curriculumDetail">
        ...
        <div class="main clearfix">
            <div class="bigBlock fl" v-if="JSON.stringify(courseList.length)!='{}'">
                ...
                <!-- 简介、目录、评论和下载 -->
                <div class="content">
                    <v-coursecatelog :activeName="activeName" :courseList="courseList" :loadMsg="loadMsg" :catalogs="catalogs" :privileMsg="privileMsg" :config="config" :changeImg="changeImg" :totalEvaluateInfo="totalEvaluateInfo" :commentator="commentator" :loadEvaluate="loadEvaluate"
                        :pageCount="pageCount" :sumUserStart="sumUserStart" :pagemsg="pagemsg" @pagechange="handleCurrentChange" @selectActiveTab="selectActiveTab"></v-coursecatelog>
                </div>
                <!-- 课程评价-->
