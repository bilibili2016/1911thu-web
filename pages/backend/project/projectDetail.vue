    ...
    <div class="proContent">
      <el-tabs v-model="activeName" class="proTab">
        <el-tab-pane label="介绍" name="first">
          ...
          <div
            class="introduction"
            v-html="projectDetail.introduction"
            v-if="project.types === '2'"
          ></div>
        </el-tab-pane>
        <el-tab-pane label="线上课程" name="second">
          <v-procourse
            :vipGoodsList="projectDetail.vipGoodsList"
            v-loading="inlineLoad"
        ...
        <el-tab-pane
          label="线下课程目录"
          name="third"
          v-if="project.types == '1'&&projectDetail.study_type =='2' "
        >
          <v-offlinedesc :project="project" :data="projectDetail"></v-offlinedesc>
        </el-tab-pane>
        <!-- 混合项目 和 自定制项目 显示 -->
        <el-tab-pane
          label="线下课程说明"
          name="third"
          v-if="project.types == '2'&&projectDetail.study_type =='2' "
        >
          <v-offlinedesc :project="project" :data="projectDetail"></v-offlinedesc>
        </el-tab-pane>
