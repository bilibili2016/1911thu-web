<template>
  <div class="schoolIntro">
    <div class="schoolBanner">
      ...
      <p>通过在各地1911学堂的学习，学员们能够夯实专业基础、提高决策能力、增强组织才能、打造战略思维、树立创新精神、提升人文素养、开拓人脉资源，并获得清华大学在线学习认证证书。</p>
      <p>与此同时，在1911学堂总部的支持下，各城市分校也将在办学中获得成长与收益。</p>
    </div>
    <div class="schoolInfo">
      <img class="schoolImg topImg" src="http://h5-image.1911edu.com/schoolIntro2.png" alt="">
      <div class="color">
