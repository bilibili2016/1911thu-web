      ...
      <el-tabs type="card" tab-position="left" @tab-click="handleClick">
        ...
        <el-tab-pane v-for="item in titleListData" :label="item.title" :key="item.id">
          <span slot="label" class="tabList">
            <i class="item-icon" :class="{iconIntro:item.title==='集团介绍',iconTeacher:item.title==='讲师招聘',iconPeople:item.title==='人才招聘',iconHelp:item.title==='帮助中心',iconContact:item.title==='联系我们'}"></i>
            {{item.title}}
          </span>
