  ...
  <div class="homeUs">
    ...
    <div class="content">
      <el-tabs type="card" tab-position="left">
        <el-tab-pane label="集团介绍" tab-click="getDetail">
          <span slot="label" class="tabList qqq">
        ...
        <el-tab-pane label="讲师招聘">
          ...
          <el-card class="card-style"></el-card>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    titleList() {
      return new Promise((resolve, reject) => {
        About.titleList().then(res => {
          ...
          console.log(this.titleListData)
    ...
    companyIntr() {
      return new Promise((resolve, reject) => {
        About.aboutDetail({ id: this.titleListData[0].id }).then(res => {
          console.log(res)
          // this.titleListData = res.data
          resolve(true)
        })
