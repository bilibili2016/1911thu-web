<template>
  <div class="allInfo">
    <div
      :class="{ topImg: true, topFixed:istopFixed, topRelative:istopRelative}"
      ref="topImg"
    >
      <img
        src="http://static-image.1911edu.com/hrentry-pic5.png"
        alt=""
      >
      <div class="top-text">
    ...
    >
      <div class="why">
        ...
        <div class="why-con clearfix">
          <div class="img">
            <img
              src="http://static-image.1911edu.com/institutional-icon.png"
              alt=""
            >
          </div>
          <div class="con-text">
      ...
      >
        <img
          class="buttom-bg"
          src="http://static-image.1911edu.com/hrentry-bg.png"
          alt=""
        >
        <div class="word">
            ...
            >
              ...
              >
                <el-radio
                  ...
                  label="上午（09:00-11:30）"
                >上午（09:00-11:30）</el-radio>
                <el-radio
                  v-model="company.time"
                  label="下午（13:00-17:30）"
                >下午（13:00-17:30）</el-radio>
              </el-form-item>
              <el-form-item
                label=""
                prop="phones"
...
export default {
  ...
  methods: {
    ...
    async handleGetCode(data) {
      ...
      if (
        this.company.phones === "" ||
        !/^[1][2,3,4,5,6,7,8,9][0-9]{9}$/.test(this.company.phones)
      ) {
        this.$message({
          showClose: true,
          type: "error",
