  ...
  <div class="policyPrograme">
    <div class="banner">
      <div class="text">
        <p class="small-title">
          ...
          <span class="desc">在线高级研修班</span>
          <span class="line"></span>
        </p>
        <p class="title-bg">党政干部综合能力提升</p>
      </div>
    </div>
    <div class="content-one">
      <div class="content-inner">
        <div class="program-bg">
          <div class="title">
            <img class="titlt-icon-left" src="http://static-image.1911edu.com/program-yellow-icon1.png" alt="">
            <span class="text">项目背景</span>
            <img class="titlt-icon-right" src="http://static-image.1911edu.com/program-yellow-icon2.png" alt="">
          </div>
          <div class="desc">
        ...
        <div class="teach-info">
          ...
          <div class="item clearfix">
            ...
            <div class="right">
              ...
              <p class="text">
                1911学堂在新时代背景中不断创新，结合党政干部的职业特点和学习需求，研发推出了在线学习的培训体系。 党政干部学员登录1911学堂（www.1911edu.com）教学平台在线学习相关课程内容。
              </p>
            </div>
          </div>
          <div class="item clearfix">
            ...
            <div class="right">
              ...
              <p class="text">
                共52学时，每学时=45分钟（下同）。 自注册账号之日起，登录1911学堂网站（www.1911edu.com）或APP教学平台在线学习相关课程内容，有效期12个月。
              </p>
            </div>
          </div>
          <div class="item clearfix">
            ...
            <div class="right">
              ...
              <p class="text">
                40元/学时/人（账号），共52学时，2080元/人。<br /> 学员账号越多，将享受更多优惠折扣。
                <br /> 1911学堂可提供增值税专用发票。
              </p>
            </div>
          </div>
            ...
            <div class="info info1">
              <div class="item clearfix">
                ...
                <div class="right">
                  ...
                  <p class="text">
                    在线学习、行动学习、翻转课堂、深度学习、跨界学习、个性化学习、沉浸式学习、探索式学习、交互式学习、自主学习、同伴学习。 </p>
                </div>
              </div>
            </div>
            <div class="info info2">
              <div class="item clearfix">
                ...
                <div class="right">
                  ...
                  <p class="text">
                    高便捷性、移动化、碎片化、随时随地学习；<br /> 单位时间内比传统的面授培训学到更多更权威的内容；
    ...
    <div class="system">
      ...
      <div class="studyCourse">
        <div class="title">
          <img class="titlt-icon-left" src="http://static-image.1911edu.com/policy-pic05.png" alt="">
          <span class="text">课程及师资介绍</span>
          <img class="titlt-icon-right" src="http://static-image.1911edu.com/policy-pic06.png" alt="">
        </div>
        <div class="studyInfo">
          <h5>
