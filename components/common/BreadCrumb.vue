<template>
  ...
  <div class="breadCrumb">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="main-crumbs">
      ...
      <el-breadcrumb-item v-if="!config.home&&config.type=='courseDetail'" :to="{ path: '/course/category?cid='+config.categoryId+'&cp=0&pids=0&xid=0' }">{{config.category}}</el-breadcrumb-item>
      <!-- 跳转到项目详情 -->
