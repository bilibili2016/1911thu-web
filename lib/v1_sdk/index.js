 ...
 * @Last Modified time: 2018-11-20 14:41:19
 * @Describe:
 */
...
export { default as examine } from './Profile/Examine'
export { default as college } from './Profile/College'
export { default as simulationExam } from './Profile/SimulationExam'
...
export { default as institutional } from './Other/Institutional'
...
export { default as players } from './Course/Player'
export { default as category } from './Course/Category'
export { default as categorylist } from './Course/CategoryList'
// components
export { default as tabs } from './Components/Tabs'
export { default as pay } from './Components/Pay'
export { default as conSearch } from './Components/Search'
...
// 自定制项目
export { default as customerProject } from './Project/CustomerProject'
// VIP会员
export { default as vip } from './Home/Vip'
// 考试认证
