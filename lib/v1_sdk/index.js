 ...
 * @Last Modified time: 2019-01-18 15:35:22
 * @Describe:
 */
...
from './Home/Home'
export { default as coursedetail }
from './Course/CourseDetail'
export { default as newlesson }
from './Course/NewLesson'

// export { default as players } from './Course/Player'
export { default as affirmOrder }
from './Shop/AffirmOrder'
export { default as shopcart }
from './Shop/ShopCart'
export { default as wepay }
from './Shop/WePay'

// profile相关
export { default as profileHome }
from './Profile/ProflieHome'
export { default as binding }
from './Profile/Binding'
export { default as conversion }
from './Profile/Conversion'
export { default as info }
from './Profile/Info'
export { default as personalset }
from './Profile/PersonalSet'
export { default as ticketorder }
from './Profile/TicketOrder'
export { default as ticketHistory }
from './Profile/TicketHistory'
export { default as order }
from './Profile/Order'
export { default as courseList }
from './Profile/CourseList'
export { default as examine }
from './Profile/Examine'
export { default as college }
from './Profile/College'

// project相关
export { default as paypublic }
from './Shop/PayPublic'
export { default as payResult }
from './Shop/PayResult'
export { default as projectdetail }
from './Project/ProjectDetail'
export { default as projectplayer }
...
from './Other/Other'
export { default as institutional }
...
from './Teacher/List'
export { default as teacherInfo }
from './Teacher/Info'

// course 相关
export { default as search }
from './Course/Search'
export { default as players }
from './Course/Player'
export { default as category }
from './Course/Category'
export { default as categorylist }
from './Course/CategoryList'
    // components
export { default as tabs }
from './Components/Tabs'
export { default as pay }
from './Components/Pay'
export { default as conSearch }
from './Components/Search'
export { default as line }
...
// 自定制项目
export { default as customerProject }
from './Project/CustomerProject'
    // VIP会员
export { default as vip }
from './Home/Vip'
    // 考试认证

// 城市分校
export { default as school }
from './School/School'
    // 后台预览
export { default as previewapi }
from './Backend/PreviewAPI'
