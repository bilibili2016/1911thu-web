...
class Home {
  ...
  async addChecked({
    ...
    // console.log(cartid, '这是curriculumcartid')
  ...
  //  获取购物车列表
  async shopCartList() {
    //  console.log(numberArr, '这是curriculumcartid')
  ...
  async upImg({
    ...
    console.log('ddfile-----ddd----', file)
    let data = await this.http.post('Wapi/MyInfo/uploadHeadImg', { FILES: file })
    return data
  }
