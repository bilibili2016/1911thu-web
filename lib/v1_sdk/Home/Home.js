...
class Home {
  ...
  async getUsedInvitationCodeList() {
    let data = await this.http.post('Wapi/InvitationCode/buildIngInvitationCodeList')
    return data
  }
  // 检测课程兑换码是否包含已购课程 
  async detectionCode({
    ...
    let data = await this.http.post('Wapi/InvitationCode/detectionInvitationCode', {
  ...
  async bindingCurriculumPrivate({
    ...
    let data = await this.http.post('Wapi/InvitationCode/buildIngInvitationCodeDone', {
      invitation_code: courseId
    })
    return data
  }
  ...
  async getProjectInfo({
    ...
    let data = await this.http.get('Wapi/CurriculumProject/curriculumProjectDetail', {
      id: projectId
    })
    return data
  }
