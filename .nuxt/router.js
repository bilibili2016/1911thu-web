...
const _facd4b7c = () => import('../pages/other/hrEntryNew.vue' /* webpackChunkName: "pages/other/hrEntryNew" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/other/hrEntryNew",
			component: _facd4b7c,
			name: "other-hrEntryNew"
		},
		{
