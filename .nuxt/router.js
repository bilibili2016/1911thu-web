...
const _6f15333f = () => import('../pages/backend/header/header.vue' /* webpackChunkName: "pages/backend/header/header" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/backend/header/header",
			component: _6f15333f,
			name: "backend-header-header"
		},
		{
