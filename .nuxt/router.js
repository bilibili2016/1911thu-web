...
const _1d43a8d6 = () => import('../pages/profile/components/myexamine/answerQuestion的副本.vue' /* webpackChunkName: "pages/profile/components/myexamine/answerQuestion的副本" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/profile/components/myexamine/answerQuestion的副本",
			component: _1d43a8d6,
			name: "profile-components-myexamine-answerQuestion的副本"
		},
		{
